...
export const exponentialAdultsReq = new TicketTypeRequest("ADULT", 123e5)
...
export const giantGroupReq = [twentyFiveAdultsReq, oneInfantReq, twoChildReq, twentyFiveAdultsReq];
